      ...
      <div class="flex gap-4">
        <?php $__currentLoopData = $writers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $writer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="w-64 h-s rounded-lg flex flex-col items-center justify-center shadow-md shadow-gray-400 bg-white">
            <div class="relative w-32 h-32 overflow-hidden rounded-full border-2 border-gray-300 bg-gray-100 flex items-center justify-center">
              <?php if($writer->photo): ?>
                <img src="<?php echo e(asset('storage/' . $writer->photo)); ?>" alt="Writer Photo" class="w-32 h-32 object-cover rounded mt-2">
              <?php endif; ?>
            </div>
            <div class="mt-4 text-center w-full">
              <h1 class="block font-semibold"><?php echo e($writer->name); ?></h1>
              <p class="text-sm text-gray-700 items-center line-clamp-3"> 
               <?php echo e($writer->biography); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/BookApp/AppBook/resources/views/writer/index.blade.php ENDPATH**/ ?>